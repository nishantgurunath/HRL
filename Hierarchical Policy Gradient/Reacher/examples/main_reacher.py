...
optim_policy_m = torch.optim.Adam(policy_mgr.parameters(), lr=0.001)
optim_policy_w = torch.optim.Adam(policy_wrk.parameters(), lr=0.001)
optim_value_m = torch.optim.Adam(value_mgr.parameters(), lr=0.001)
optim_value_w = torch.optim.Adam(value_wrk.parameters(), lr=0.001)
